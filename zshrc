...
export ZSH="/Users/chenjian/.oh-my-zsh"
...
plugins=(sudo vscode git autojump autopep8 httpie macos pep8 pip postgres python pylint tmux zsh-completions zsh-syntax-highlighting)
...
# python
alias p="python3 -m better_exceptions"
# no .pyc
...
alias git-blame="/usr/local/bin/git-blame-someone-else"
