...
alias mysqlrestart="sudo /usr/local/Cellar/mysql/5.7.11/bin/mysql.server restart"
alias mysqlreload="sudo /usr/local/Cellar/mysql/5.7.11/bin/mysql.server reload"
alias mysqlforcereload="sudo /usr/local/Cellar/mysql/5.7.11/bin/mysql.server force-reload"
alias mysqlstatus="sudo /usr/local/Cellar/mysql/5.7.11/bin/mysql.server status"
